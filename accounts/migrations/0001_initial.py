# Generated by Django 6.0.6 on 2026-06-11 16:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'Aluno'), ('teacher', 'Professor'), ('admin', 'Administrador')], default='student', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.CharField(choices=[('mage_blue', 'Mago Azul'), ('mage_red', 'Mago Vermelho'), ('witch_green', 'Bruxa Verde'), ('witch_purple', 'Bruxa Roxa')], default='mage_blue', max_length=20)),
